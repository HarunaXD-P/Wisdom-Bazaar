...
if __name__ == '__main__':
    ...
    # check json
    info_json = json_parser_0.json_parser('target.json')
    
    # definition
    # state 0: query info about user
    # state 1: query info about product
    # state 2: query info about correlation: use product id
    # state 3: query info about correlation: use user id
    # state 4: add info about user
    # state 5: add info about product
    state_info = info_json['state']
    
    # each state has an exclusive format
    ...
    # packing the desired json file according to requirements8g
    # each state has an exclusive format
    if (state_info == 0):
