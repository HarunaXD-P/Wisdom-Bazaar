...
SQLALCHEMY_BINDS = {
    'database_0': 'mysql+pymysql://root:123456@127.0.0.1:3306/test_1_0',
    'database_1': 'mysql+pymysql://root:123456@127.0.0.1:3306/test_1_1',
}
...
def register_x():
    ...
    # register
        ...
        db.session.commit(bind='database_0')
...
@app.route('/')
def hello_world():
    return 'Hello world for lexie_version_2 on our server.'
