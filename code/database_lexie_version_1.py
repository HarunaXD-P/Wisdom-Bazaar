...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:123456@127.0.0.1:3306/test_1_0'
...
if __name__ == '__main__':
    ...
    # db.session.add_all([user1, user2, user3, product1, product2, product3, product4, product5, product6, product7, product8])
