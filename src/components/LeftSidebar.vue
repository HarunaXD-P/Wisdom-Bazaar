...
<template>
  <div class="LeftSidebar">
	<span style="font-size: 48px;">商品分类</span>
    <el-row class="tac">
      <el-col :span="24">
        <el-menu
          default-active="1"
          ...
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="1-1" @click="getclick11()">苹果手机</el-menu-item>
              <el-menu-item index="1-2" @click="getclick12()">安卓手机</el-menu-item>
            </el-menu-item-group>
